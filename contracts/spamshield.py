...
# SpamShield - AI spam filter on GenLayer.
...
SCORE_TOLERANCE = 25
CATEGORIES = ("ham", "promotional", "spam")
DEFAULT_LABEL = "ham"
...
class SpamShield(gl.Contract):
    ...
    def evaluate(self, item_id: int) -> None:
        ...
        def leader_fn():
            ...
            prompt = f"""You are a spam filter. Classify the MESSAGE.
...
Classify the CONTENT as exactly one of: ham, promotional, spam.
Also give an integer spamminess score from 0 to 100, and a one-sentence reason.

Respond with ONLY JSON: {{"label": "<one of: ham, promotional, spam>", "score": <integer 0-100>, "reasoning": "<one sentence>"}}"""
